...
The problem appears with simple Hello World demo with RISC-V based system. Board A works well, on board B once out five attempts one character goes missing on the UART output.
